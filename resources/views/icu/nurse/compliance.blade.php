    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start space-x-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700 mt-1">This page has been moved to <a href="/icu/nurse/compliance-reports" class="text-blue-600 underline hover:text-blue-800">/icu/nurse/compliance-reports</a></p>
...
setTimeout(function() {
    window.location.href = '/icu/nurse/compliance-reports';
}, 3000);
</script>

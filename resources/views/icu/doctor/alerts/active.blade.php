...
@section('content')
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div class="min-w-0">
            <h1 class="text-2xl font-semibold tracking-tight">Active Alerts</h1>
            <div class="text-sm text-slate-500">Open alerts requiring action (DB-backed).</div>
        </div>
        ...
        <div class="mt-4 overflow-x-auto rounded-2xl border border-slate-200/80">
            <table class="min-w-[1400px] w-full text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr class="border-t border-slate-200/80"><td colspan="5" class="px-4 py-6 text-slate-500">No active alerts.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
